...
/* Tint and the resting angle come from the design's alternating rhythm, and
 * live with the quotes in src/content so the assistant can quote them too. */
const NOTES = TESTIMONIALS.map((note, i) => ({ ...note, id: i }));
